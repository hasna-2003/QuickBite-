...
const cart = () => {
    const {foodList, quantities, increaseQuantity, decreaseQuantity} = useContext(StoreContext);
            ...
            <div className="card mb-4">
                <div className="card-body">
                    <div className="row cart-item mb-3">
                        ...
                        <div className="col-md-2">
                            <div className="input-group">
                                ...
                                <input style={{"max-width": "100px"}} type="text" className="form-control  form-control-sm text-center quantity-input"/>
                                <button className="btn btn-outline-secondary btn-sm" type="button">+</button>
                            </div>
                        </div>
                    ...
                    <div className="row cart-item">
                        <div className="col-md-3">
                            <img src="https://via.placeholder.com/100" alt="Product 2" className="img-fluid rounded"> </img>
                        </div>
                        <div className="col-md-5">
