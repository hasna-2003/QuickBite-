...
const Cart = () => {
    const {foodList, quantities, increaseQuantity, decreaseQuantity, removeFromCart} = useContext(StoreContext);
        ...
        <div className="col-lg-8">
            {
             cartItems.length === 0 ? (
                <div className="alert alert-info d-flex justify-content-between align-items-center" role="alert">
                    ...
                    <Link to="/explore" className="btn btn-primary btn-sm">Continue Shopping</Link>
                </div>
             ) : (
        ...
        <div className="col-lg-4">
            <div className="card cart-summary">
                <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between mb-3">
                        <span>Shipping</span>
                            <span>Rs.{subtotal === 0 ? '0.00' : shipping.toFixed(2)}</span>
                    </div>
                    <div className="d-flex justify-content-between mb-3">
                        <span>Tax</span>
                    ...
                    <button className="btn btn-primary w-100" disabled={cardItems.length === 0} onClick={() => navigate('/order')}>
                        Proceed to Checkout
                    </button>
                </div>
            </div>
